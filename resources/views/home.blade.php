...
@section('content')
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-4">
                            <select name="category" class="form-select form-select-lg">
                                ...
                                <option value="jewellery" {{ request('category') == 'jewellery' ? 'selected' : '' }}>Jewellery
                                </option>
                                <option value="textiles" {{ request('category') == 'textiles' ? 'selected' : '' }}>Textiles
                                </option>
            ...
            <div class="card-body p-4">
                <div class="row align-items-center">
                    <div class="col-md-2 text-center mb-3 mb-md-0">
                        ...
                        <span class="badge bg-secondary" style="background-color: #2D5016 !important;">Artisan of the
                            Week</span>
                    </div>
                    <div class="col-md-7">
                        <h5 class="mb-1">{{ $artisanOfTheWeek->name }}</h5>
                        <p class="text-muted small mb-1">📍 {{ $artisanOfTheWeek->town }}, {{ $artisanOfTheWeek->county }} ·
                            {{ ucfirst($artisanOfTheWeek->category) }}</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    @if($artisan->cover_image)
                        <img src="{{ $artisan->cover_image }}" class="card-img-top"
                            style="height: 200px; object-fit: cover; border-radius: 15px 15px 0 0;" alt="{{ $artisan->name }}">
                    @endif
                    <div class="card-body p-4">
    ...
    @if($artisans->hasPages())
        ...
        <p class="text-center text-muted small mt-2">Showing {{ $artisans->firstItem() }} to {{ $artisans->lastItem() }} of
            {{ $artisans->total() }} artisans</p>
    @endif
