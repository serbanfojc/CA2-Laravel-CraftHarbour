...
<body>
    ...
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Your full name">
            @error('name') <span class="auth-error">{{ $message }}</span> @enderror

            <label for="email">Email address</label>
            <input type="email" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="email@example.com">
            ...
            <select id="role" name="role">
                <option value="member" {{ old('role') == 'member' ? 'selected' : '' }}>Member — I want to find and review artisans</option>
                <option value="artisan" {{ old('role') == 'artisan' ? 'selected' : '' }}>Artisan — I want to list my craft</option>
            </select>
