    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body p-4">
                <h4 class="mb-4">Add a Workshop</h4>
                ...
                <form method="POST" action="/workshops">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="duration_hours" class="form-control" step="0.5" value="{{ old('duration_hours') }}">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary w-100">Create Workshop</button>
