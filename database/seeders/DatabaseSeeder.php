...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $reviews = [
            ['user_id' => 17, 'artisan_id' => 1, 'rating' => 5, 'title' => 'Absolutely stunning work', 'body' => 'Niamh made a set of mugs for us as a wedding gift. The quality is incredible and she was so easy to deal with.'],
            ['user_id' => 18, 'artisan_id' => 1, 'rating' => 4, 'title' => 'Really lovely pieces', 'body' => 'Bought a bowl and a side plate. Beautifully made and arrived well packaged. Would definitely order again.'],
            ['user_id' => 19, 'artisan_id' => 1, 'rating' => 5, 'title' => 'Best ceramics I have ever bought', 'body' => 'I stumbled across this listing and I am so glad I did. The craftsmanship is on another level.'],
            ['user_id' => 20, 'artisan_id' => 1, 'rating' => 4, 'title' => 'Great workshop experience', 'body' => 'Attended the wheel throwing workshop. Niamh is a brilliant teacher and so patient. Highly recommend.'],
            ['user_id' => 21, 'artisan_id' => 1, 'rating' => 5, 'title' => 'Perfect gift', 'body' => 'Ordered a custom piece as a birthday gift. Niamh was great to communicate with and the finished product was perfect.'],
            ['user_id' => 17, 'artisan_id' => 2, 'rating' => 5, 'title' => 'Incredible craftsmanship', 'body' => 'Conor built a dining table for us. It is absolutely beautiful and built to last generations. Worth every cent.'],
            ['user_id' => 18, 'artisan_id' => 2, 'rating' => 5, 'title' => 'Outstanding quality', 'body' => 'Had a custom bookshelf made. The attention to detail is unreal. Everyone who visits comments on it.'],
            ['user_id' => 19, 'artisan_id' => 2, 'rating' => 4, 'title' => 'Very happy with my order', 'body' => 'Ordered a small side table. Took a few weeks but the wait was worth it. Really solid piece of furniture.'],
            ['user_id' => 17, 'artisan_id' => 3, 'rating' => 4, 'title' => 'Beautiful jewellery', 'body' => 'Bought a silver necklace for my mam. She absolutely loves it. Really delicate and well made.'],
            ['user_id' => 18, 'artisan_id' => 3, 'rating' => 5, 'title' => 'Stunning pieces', 'body' => 'Aoife made a custom engagement ring for me. It is exactly what I wanted and the whole process was great.'],
            ['user_id' => 19, 'artisan_id' => 4, 'rating' => 5, 'title' => 'Best leather wallet I have owned', 'body' => 'Bought a bifold wallet. The leather quality is top notch and it has aged really well after a few months of use.'],
            ['user_id' => 20, 'artisan_id' => 4, 'rating' => 4, 'title' => 'Really solid work', 'body' => 'Bought a leather card holder. Small but perfectly made. You can tell a lot of care went into it.'],
            ['user_id' => 18, 'artisan_id' => 5, 'rating' => 4, 'title' => 'Gorgeous throw', 'body' => 'Bought a wool throw for the couch. Really well made and the colours are lovely. Great addition to the living room.'],
            ['user_id' => 19, 'artisan_id' => 5, 'rating' => 5, 'title' => 'Unique and beautiful', 'body' => 'Bought a wall hanging. It is a real statement piece and completely unique. So happy with it.'],
            ['user_id' => 17, 'artisan_id' => 6, 'rating' => 5, 'title' => 'Magical glass blowing experience', 'body' => 'Did the glass blowing taster session. One of the most unique experiences I have ever had. Padraig is a brilliant teacher.'],
            ['user_id' => 20, 'artisan_id' => 6, 'rating' => 4, 'title' => 'Beautiful glass pieces', 'body' => 'Bought a handblown vase as a housewarming gift. It was a real talking point at the party.'],
            ['user_id' => 18, 'artisan_id' => 7, 'rating' => 5, 'title' => 'Loved the pottery class', 'body' => 'Did the beginners pottery class with Sinead. She is so patient and encouraging. Left with a pot I am actually proud of.'],
            ['user_id' => 19, 'artisan_id' => 7, 'rating' => 4, 'title' => 'Really lovely studio', 'body' => 'Visited Sinead to pick up a commission. The studio is beautiful and the work on display is stunning.'],
            ['user_id' => 17, 'artisan_id' => 8, 'rating' => 5, 'title' => 'Amazing bespoke table', 'body' => 'Declan made a custom dining table for our new home. The quality is extraordinary and it arrived on time.'],
            ['user_id' => 21, 'artisan_id' => 8, 'rating' => 5, 'title' => 'Wood carving workshop was brilliant', 'body' => 'Did the wooden spoon carving workshop. Declan is so knowledgeable and the whole day was really enjoyable.'],
            ['user_id' => 18, 'artisan_id' => 9, 'rating' => 4, 'title' => 'Lovely silver jewellery', 'body' => 'Bought a pair of Celtic knot earrings for my sister. She was absolutely delighted with them.'],
            ['user_id' => 20, 'artisan_id' => 10, 'rating' => 5, 'title' => 'Beautiful macrame piece', 'body' => 'Attended the macrame wall hanging workshop. Fionnuala is a wonderful teacher and I left with a piece I am so proud of.'],
            ['user_id' => 17, 'artisan_id' => 11, 'rating' => 4, 'title' => 'Quality leather goods', 'body' => 'Bought a handmade leather bag. The stitching is perfect and the leather is really high quality.'],
            ['user_id' => 19, 'artisan_id' => 12, 'rating' => 5, 'title' => 'Wonderful ceramics workshop', 'body' => 'Did the pinch pot class with Aisling. She makes everything so accessible and fun. Will definitely be back.'],
            ['user_id' => 18, 'artisan_id' => 13, 'rating' => 5, 'title' => 'Incredible wood carving skills', 'body' => 'Tadhg carved a custom piece for our fireplace mantle. The detail is incredible and he was a pleasure to work with.'],
            ['user_id' => 21, 'artisan_id' => 14, 'rating' => 4, 'title' => 'Stunning stained glass', 'body' => 'Grainne made a custom stained glass panel for our front door. It completely transforms the hallway.'],
            ['user_id' => 17, 'artisan_id' => 15, 'rating' => 5, 'title' => 'Beautiful wedding rings', 'body' => 'Eoghan made our wedding rings. They are absolutely perfect and exactly what we wanted. Could not recommend him more.'],
            ['user_id' => 20, 'artisan_id' => 15, 'rating' => 5, 'title' => 'Exceptional jewellery maker', 'body' => 'Had a custom necklace made as an anniversary gift. Eoghan communicated brilliantly throughout and the result was stunning.'],
        ];
